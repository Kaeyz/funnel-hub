...
import EditForm from "./edit-questions.vue";
import { computed, ref } from "vue";
import { useRouter } from "vue-router";
import { routes } from "@/router/routes";
import { useApi } from "@/composables/useApi";
import { toast } from "vue-sonner";
import type { Question } from "@/services/types/question.type";
import { updateQuestionStatus } from "@/services/questions";
  ...
  <div>
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem @click="goToQuestionsPreview">Preview</DropdownMenuItem>
    ...
    <EditForm
      :data="rowData"
      :open="editIsOpen"
      :toggle-drawer="toggleEdit"
      :refresh-forms="refreshTable"
      :form-id="formId"
